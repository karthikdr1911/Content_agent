...
import React173, { useCallback as useCallback129, useEffect as useEffect76, useMemo as useMemo130 } from "react";
...
import { useCallback as useCallback122, useMemo as useMemo125 } from "react";
...
import { jsx as jsx247, jsxs as jsxs128, Fragment as Fragment41 } from "react/jsx-runtime";
var MIN_SCALE = 0.1;
var MAX_SCALE = 10;
...
var ScaleSetting = ({ scale, setScale, compositionWidth, compositionHeight }) => {
  const outputDimensions = useMemo124(() => {
...
// src/components/RenderModal/RenderModalPicture.tsx
import { jsx as jsx248, jsxs as jsxs129, Fragment as Fragment42 } from "react/jsx-runtime";
...
var RenderModalPicture = ({
  ...
  const colorSpaceOptions = useMemo125(() => {
  ...
  const qualityControlOptions = useMemo125(() => {
  ...
  return /* @__PURE__ */ jsxs129("div", {
    ...
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: [
      renderMode === "video" ? /* @__PURE__ */ jsxs129("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx248("div", {
            style: label5,
      ...
      shouldDisplayQualityControlPicker && renderMode === "video" ? /* @__PURE__ */ jsxs129("div", {
        style: optionRow,
        children: [
          /* @__PURE__ */ jsx248("div", {
            style: label5,
      ...
      qualityControlType === "bitrate" && renderMode === "video" ? /* @__PURE__ */ jsxs129("div", {
        style: optionRow,
        children: [
      ...
      renderMode === "video" ? /* @__PURE__ */ jsxs129(Fragment42, {
        children: [
          /* @__PURE__ */ jsxs129("div", {
            style: optionRow,
            children: [
          ...
          encodingBufferSize === null ? null : /* @__PURE__ */ jsxs129("div", {
            style: optionRow,
            children: [
              /* @__PURE__ */ jsx248("div", {
                style: label5,
          ...
          encodingMaxRate === null ? null : /* @__PURE__ */ jsxs129("div", {
            style: optionRow,
            children: [
              /* @__PURE__ */ jsx248("div", {
                style: label5,
...
// src/components/RenderModal/RenderModal.tsx
import { jsx as jsx249, jsxs as jsxs130 } from "react/jsx-runtime";
...
var RenderModal = ({
  ...
  const supportsBothQualityControls = useMemo126(() => {
    return supportsCrf && supportsVideoBitrate;
  }, [supportsCrf, supportsVideoBitrate]);
  const qualityControlType = useMemo126(() => {
  ...
  const muted = useMemo126(() => {
    if (renderMode === "video") {
      return mutedState;
    }
    return false;
  }, [mutedState, renderMode]);
  const enforceAudioTrack = useMemo126(() => {
    if (renderMode === "video") {
  ...
  const everyNthFrame = useMemo126(() => {
    if (codec === "gif") {
  ...
  const availablePixelFormats = useMemo126(() => {
    return BrowserSafeApis10.validPixelFormatsForCodec(codec);
  }, [codec]);
  const pixelFormat = useMemo126(() => {
  ...
  const imageFormatOptions = useMemo126(() => {
    if (renderMode === "still") {
      return [
        {
          label: "PNG",
  ...
  const renderTabOptions = useMemo126(() => {
  ...
  const pixelFormatOptions = useMemo126(() => {
      ...
      /* @__PURE__ */ jsxs130("div", {
        ...
        children: [
          /* @__PURE__ */ jsxs130("div", {
            style: leftSidebar,
            children: [
              shownTabs.includes("general") ? /* @__PURE__ */ jsxs130(VerticalTab, {
                style: horizontalTab,
              ...
              shownTabs.includes("data") ? /* @__PURE__ */ jsxs130(VerticalTab, {
                style: horizontalTab,
                selected: tab === "data",
                onClick: () => setTab("data"),
                children: [
              ...
              shownTabs.includes("picture") ? /* @__PURE__ */ jsxs130(VerticalTab, {
                style: horizontalTab,
              ...
              shownTabs.includes("audio") ? /* @__PURE__ */ jsxs130(VerticalTab, {
                style: horizontalTab,
                selected: tab === "audio",
              ...
              shownTabs.includes("gif") ? /* @__PURE__ */ jsxs130(VerticalTab, {
                style: horizontalTab,
                selected: tab === "gif",
                onClick: () => setTab("gif"),
                children: [
              ...
              shownTabs.includes("advanced") ? /* @__PURE__ */ jsxs130(VerticalTab, {
                style: horizontalTab,
...
var RenderingProgress = ({ progress }) => {
  return /* @__PURE__ */ jsxs131("div", {
    ...
    children: [
      ...
      progress.doneIn ? /* @__PURE__ */ jsxs131("div", {
        style: right3,
        children: [
          progress.doneIn,
          "ms"
...
// src/components/RenderModal/RenderStatusModal.tsx
import { jsx as jsx252, jsxs as jsxs132, Fragment as Fragment43 } from "react/jsx-runtime";
var container59 = {
  padding: 20,
  maxWidth: 900,
  paddingTop: 0
...
var RenderStatusModal = ({
  ...
  return /* @__PURE__ */ jsxs132(ModalContainer, {
    onOutsideClick: onQuit,
    onEscape: onQuit,
    children: [
      ...
      /* @__PURE__ */ jsxs132("div", {
        style: container59,
        children: [
          job.status === "failed" ? /* @__PURE__ */ jsxs132(Fragment43, {
            children: [
              /* @__PURE__ */ jsx252("p", {
...
var CopyButton = ({ textToCopy, label: label10, labelWhenCopied }) => {
  ...
  return /* @__PURE__ */ jsxs133(Button, {
    onClick,
    buttonContainerStyle,
    children: [
      copyIcon,
...
import { useCallback as useCallback127, useMemo as useMemo128, useState as useState79 } from "react";
...
import { jsx as jsx255, jsxs as jsxs134 } from "react/jsx-runtime";
var container60 = {
  display: "flex",
  flexDirection: "row",
  alignItems: "center"
...
// src/components/UpdateModal/UpdateModal.tsx
import { jsx as jsx256, jsxs as jsxs135, Fragment as Fragment44 } from "react/jsx-runtime";
var container61 = {
  padding: 20,
  paddingTop: 0
};
...
var UpdateModal = ({ info, knownBugs }) => {
  ...
  return /* @__PURE__ */ jsxs135(DismissableModal, {
    children: [
      ...
      /* @__PURE__ */ jsxs135("div", {
        style: container61,
        children: [
          hasKnownBugs ? /* @__PURE__ */ jsxs135(Fragment44, {
            children: [
              /* @__PURE__ */ jsxs135("div", {
                style: title7,
                children: [
...
// src/components/Modals.tsx
import { jsx as jsx257, jsxs as jsxs136, Fragment as Fragment45 } from "react/jsx-runtime";
var Modals = ({ readOnlyStudio }) => {
  ...
  return /* @__PURE__ */ jsxs136(Fragment45, {
    children: [
...
// src/components/Editor.tsx
import { jsx as jsx258, jsxs as jsxs137 } from "react/jsx-runtime";
var background2 = {
  backgroundColor: BACKGROUND,
  display: "flex",
  width: "100%",
...
var Editor = ({ Root, readOnlyStudio }) => {
  ...
  const MemoRoot = useMemo130(() => {
    return React173.memo(Root);
  }, [Root]);
  return /* @__PURE__ */ jsx258(HigherZIndex, {
    onEscape: noop,
    onOutsideClick: noop,
    children: /* @__PURE__ */ jsxs137(TimelineZoomContext, {
      children: [
        /* @__PURE__ */ jsx258(Internals60.CurrentScaleContext.Provider, {
          ...
          children: /* @__PURE__ */ jsxs137("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxs137(Internals60.CanUseRemotionHooksProvider, {
                children: [
...
import { useCallback as useCallback130, useContext as useContext82, useMemo as useMemo131, useState as useState80 } from "react";
...
var PreviewSizeProvider = ({ children }) => {
  ...
  const previewSizeCtx = useMemo131(() => {
    return {
...
import { useCallback as useCallback131, useMemo as useMemo132, useState as useState81 } from "react";
...
var CheckerboardProvider = ({ children }) => {
  ...
  const checkerboardCtx = useMemo132(() => {
    return {
      checkerboard,
      setCheckerboard
    };
...
import { useMemo as useMemo133, useState as useState82 } from "react";
...
var MediaVolumeProvider = ({ children }) => {
  ...
  const mediaVolumeContextValue = useMemo133(() => {
    return {
      mediaMuted,
      mediaVolume
    };
  }, [mediaMuted, mediaVolume]);
  const setMediaVolumeContextValue = useMemo133(() => {
    return {
      setMediaMuted,
      setMediaVolume
    };
...
import { useEffect as useEffect77, useMemo as useMemo135, useState as useState84 } from "react";
...
var SetTimelineInOutProvider = ({ children }) => {
  ...
  const setTimelineInOutContextValue = useMemo135(() => {
    return {
      setInAndOutFrames
    };
  }, []);
...
import { useCallback as useCallback132, useMemo as useMemo136, useRef as useRef41, useState as useState85 } from "react";
...
var ShowGuidesProvider = ({ children }) => {
  ...
  const editorShowGuidesCtx = useMemo136(() => {
    return {
      editorShowGuides,
      setEditorShowGuides,
      guidesList,
...
import { useCallback as useCallback133, useMemo as useMemo137, useState as useState86 } from "react";
...
var ShowRulersProvider = ({ children }) => {
  ...
  const editorShowRulersCtx = useMemo137(() => {
    return {
      editorShowRulers,
      setEditorShowRulers
    };
...
import { useCallback as useCallback134, useMemo as useMemo138, useState as useState87 } from "react";
...
var ZoomGesturesProvider = ({ children }) => {
  ...
  const editorZoomGesturesCtx = useMemo138(() => {
    return {
      editorZoomGestures,
      setEditorZoomGestures
    };
...
import { jsx as jsx268, jsxs as jsxs138 } from "react/jsx-runtime";
var container62 = {
  position: "fixed",
  justifyContent: "flex-end",
  alignItems: "flex-start",
  ...
  return /* @__PURE__ */ jsx268("div", {
    ...
    children: /* @__PURE__ */ jsxs138("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx268("br", {}),
        window.remotion_studioServerCommand ? /* @__PURE__ */ jsxs138("span", {
          children: [
            "Run",
            " ",
...
// src/Studio.tsx
import { jsx as jsx269, jsxs as jsxs139 } from "react/jsx-runtime";
...
var Studio = ({ rootComponent, readOnly }) => {
  ...
  return /* @__PURE__ */ jsx269(Internals64.RemotionRoot, {
    ...
    children: /* @__PURE__ */ jsxs139(EditorContexts, {
